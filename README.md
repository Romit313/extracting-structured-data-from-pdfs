...
- Text Chunking: Split documents into manageable chunks using LangChain's RecursiveCharacterSplitter.
...
- An OpenAI API key (you can sign up at OpenAI Platform)
...
1. Clone the repository:
   ...
   ```
   git clone https://github.com/romitjain/Extracting-Structured-Data-From-PDFs
...
3. Run the Jupyter Notebook:
   If you prefer working in a notebook, open the notebooks/data_extraction_llms.ipynb file using Jupyter Lab or Notebook:
    ```
...
This project is maintained by Romit Jain, a Data and Business Analyst with over 3 years of experience in building data infrastructure and turning complex datasets into actionable insights. Romit specializes in SQL, Python, and automated ETL workflows, focusing on delivering scalable analytics solutions and improving data quality.

Email: romitt07jain@gmail.com